...
import { 
  ...
  PlayCircle, ZoomIn, X, ChevronLeft, ChevronRight, Workflow
} from 'lucide-react';
...
export default function EngineeringLab() {
  ...
  const labProjectKeys = ['lieDetector', 'krishnaSpeaks', 'visionDetect', 'minigit', 'texasHoldem', 'universeExplorer'];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
            ...
            {[
              ...
              <div key={phase.num} className={`bg-[#05070A]/80 border border-slate-800 p-6 rounded-3xl flex flex-col gap-3 group hover:border-${phase.color}-500/40 transition-all duration-300 relative overflow-hidden shadow-lg hover:shadow-[0_10px_40px_-10px_rgba(255,255,255,0.05)]`}>
                <div className={`absolute -right-1 -bottom-2 text-[70px] font-black text-white/5 select-none pointer-events-none group-hover:text-${phase.color}-500/5 transition-colors duration-500 leading-none`}>
                  {phase.num}
                </div>
            ...
            <div className="bg-blue-600/10 border border-blue-500/40 p-6 rounded-3xl flex flex-col gap-3 group transition-all duration-300 relative overflow-hidden shadow-[0_0_30px_rgba(37,99,235,0.15)] hover:bg-blue-600/20">
              ...
              <div className="flex items-center gap-3 mb-2 relative z-10">
                ...
                <span className="text-blue-200 text-[10px] font-bold uppercase tracking-widest">June, 2026</span>
              </div>
              <h4 className="text-2xl font-black text-white tracking-tight relative z-10">DevScout Arch</h4>
              <p className="text-blue-100/80 text-sm font-medium leading-relaxed relative z-10">The synthesis of 5 domains of research into one enterprise-grade platform.</p>
            </div>
        ...
        <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-black/95 backdrop-blur-2xl p-0 md:p-8 animate-in fade-in duration-300" onClick={() => setActiveIndex(null)}>
          ...
          <div className="relative w-full max-w-[90vw] md:max-w-7xl h-[100dvh] md:h-[85vh] flex flex-col items-center justify-center select-none py-20 md:py-0" onClick={e => e.stopPropagation()}>
            ...
            {activeMedia.type === 'image' && (
              <div 
                className={`w-full h-full bg-slate-50 rounded-2xl md:rounded-[2rem] flex items-center justify-center overflow-hidden shadow-2xl relative select-none touch-none ${
